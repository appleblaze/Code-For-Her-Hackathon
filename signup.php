...
if(isset($_POST['email']) && isset($_POST['pswd'])){
            ...
            return;
                ...
                if($_POST['pswd'] !== $_POST['cnpswd']){
                    $_SESSION["error"] = "Please Confirm Correct Password";
                    header( 'Location: signup.php' ) ;
                    return;
                }else {
                    ...
                    if(count($rows)==0){
                        $sql2 = "INSERT INTO user_master ( email, pswd, username) VALUES ( :email, :pswd, :user)";
        ...
        <header style="margin: 0 35%;">
            ...
            <form method="POST" enctype="multipart/form-data" style="margin: 0 auto;">
                ...
                <div class="row">
                    <div class="col-12 col-sm-6" style="margin: 0 auto;">
                        <div class="form-group">
                          <label for="cnpswd">Confirm Password*</label>
                          <input type="pswd" class="form-control" id="cnpswd" name="cnpswd" required>
                        </div>
                    </div>
                </div>
                    <div class = "row"> 
